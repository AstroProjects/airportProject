...
\input{./sections/1_Prognosis}
\input{./sections/2_Distribucion_terminal}
\input{./sections/3_Tipologia_Estructural}
\input{./sections/4_Pavimentos_Interiores}
\input{./sections/5_Fachada}
\input{./sections/6_Cubierta}
\input{./sections/7_Cerramientos_Interiores}
\input{./sections/8_Normativa_Anti_Incendios}
...
\bibliography{PROYECTO_AEROPUERTOS} 
